              ...
              >
                <CardContent className="p-0">
                  ...
                  <div className="relative w-full aspect-square overflow-hidden bg-gradient-primary">
                    ...
                    {/* Gradient Overlay */}
                    <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-[#259296]/90 via-[#259296]/40 to-transparent opacity-100 group-hover:opacity-95 transition-opacity duration-500" />
